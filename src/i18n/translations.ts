...
const ko: Translations = {
  ...
  hero: {
    badge: 'Operational Intelligence Platform',
    h1: '운영 인텔리전스로\n기업을 혁신하세요',
    subhead: '전례 없는 속도와 정확도로 데이터를 감지하고, 분석하고, 실행합니다',
    sub: 'N3N OI 플랫폼이 현장의 모든 데이터를 실시간으로 통합하여, 기업 운영의 전 과정을 하나의 인텔리전스로 연결합니다.',
    cta1: '데모 신청하기',
    cta2: '데모 보기',
    scroll: '스크롤',
    stat1: '가동률 SLA',
  ...
  industries: {
    eyebrow: 'Industries',
    h2: 'N3N이 해결하는 운영 과제',
    sub: '스마트시티부터 에너지 인프라까지, N3N OI 플랫폼은 산업 현장의 복잡한 운영 문제를 실시간 인텔리전스로 해결합니다.',
    items: [
  ...
  about: {
    ...
    h2a: 'AI와 클라우드의 융합으로',
    h2b: ' 탄생한 인텔리전스',
    body: 'N3N.ai는 지능형 비전 시스템과 AI 클라우드 인프라에 특화된 기업입니다. INNOWATCH와 WIZEYE를 통해 기업은 영상·IoT·시스템 데이터를 전례 없는 규모로 모니터링하고 분석하며, 즉각 대응할 수 있습니다.',
    cta: '운영 지능 알아보기 →',
    cards: [
      { title: '클라우드 네이티브', desc: '처음부터 확장성을 염두에 두고 설계되었습니다. 멀티 리전 지원, 장애 허용 구조, 무제한 확장성을 제공합니다.' },
      { title: '엣지 AI 처리', desc: '10ms 미만의 지연시간으로 실시간 영상 분석을 수행하며, 엣지에서 직접 인텔리전스를 실행합니다.' },
      { title: '엔터프라이즈 보안', desc: 'SOC 2 Type II 인증을 획득했으며, 제로 트러스트 아키텍처와 종단간 암호화를 제공합니다.' },
      { title: '즉시 배포', desc: '온보딩부터 프로덕션까지 몇 시간 안에 완료되는 완전 관리형 플랫폼입니다.' },
    ],
  },
  connecting: {
  ...
  products: {
    innowatch: {
      headline: '위치와 비용의 제약을',
      headlineSub: '소멸시킨 통합 비디오 관제 플랫폼',
      tag: 'INNOWATCH (가시적 데이터 통제)',
      desc: '네트워크 한계를 허물고 수천 개의 실시간 영상을 단일 통합 맵(Map)에서 관제. GIS 기반 실시간 CCTV 통합 플랫폼으로 어디서나 모든 카메라를 하나의 화면에서 관제합니다.',
      liveCount: '수천 개 동시 관제',
      features: [
        {
          title: 'Live Video on Map',
          desc: '상용 GIS 맵 위에 수천 개의 실시간 CCTV 영상과 연관 데이터를 동시 표출.',
        },
        {
          title: 'Display Wall Operation',
          desc: '본사 및 중앙 관제실의 대형 스크린 환경에 최적화된 다이나믹 채널 및 비디오 스트림.',
        },
        {
          title: 'Universal Integration',
          desc: '보안 중심의 그물망 시스템에서 데이터 종류에 상관없이 유연한 통합 모니터링 환경 제공.',
        },
      ],
    },
    wizeye: {
      ...
      desc: 'WIZEYE 대시보드는 AI가 감지한 이상 징후를 실시간 알림으로 제공하여, 문제 발생 전에 대응할 수 있도록 돕습니다. 대규모 IoT 센서 데이터를 수집·정제·분석하여 운영 효율을 높이고 비용을 절감합니다.',
      features: [
        {
          title: '실시간 객체 감지 및 추적',
          desc: 'AI 비전 모델이 실시간으로 객체를 감지, 분류, 추적합니다.',
        },
        {
          title: '행동 패턴 분석',
          desc: '복잡한 행동 패턴을 학습하고 이상 행동을 자동으로 감지하여 즉시 알림.',
        },
        {
          title: '엣지 & 클라우드 하이브리드',
          desc: '엣지 디바이스부터 클라우드까지 유연한 배포로 지연 없는 실시간 처리.',
        },
      ],
    },
    demo: '데모 신청',
  ...
  usecases: {
    eyebrow: 'Use Cases',
    h2: '검증된 산업 현장의 성과',
    sub: 'INNOWATCH와 WIZEYE가 만들어낸 실제 운영 성과. 글로벌 엔터프라이즈부터 공공 인프라까지.',
    cta: '사례 자세히 보기',
    cases: [
  ...
  tech: {
    ...
    h2a: '모든 운영 데이터,',
    h2b: ' 하나의 플랫폼에서',
    sub: '모델 학습부터 엣지 배포까지 수직 통합된 AI 스택. 클릭 한 번으로 CCTV, IoT, 서버 로그를 통합 모니터링합니다.',
    cards: [
  ...
  contact: {
    ...
    h2a: '지금 바로 운영 인텔리전스를',
    h2b: ' 경험해보세요',
    sub: '데모를 요청하거나 전문가와 상담을 원하시면 아래 양식을 작성하세요. 빠른 시일 내에 연락드리겠습니다.',
    name: '이름', namePh: '김지은',
...
const en: Translations = {
  ...
  hero: {
    ...
    sub: 'The N3N OI Platform integrates all field data in real time, connecting every stage of enterprise operations into a single intelligence layer.',
    cta1: 'Request a Demo',
    cta2: 'Watch Demo',
    scroll: 'Scroll',
    stat1: 'Uptime SLA',
  ...
  industries: {
    ...
    sub: 'From smart cities to energy infrastructure, the N3N OI Platform solves complex operational challenges with real-time intelligence.',
    items: [
  ...
  about: {
    eyebrow: 'About n3n.ai',
    h2a: 'Intelligence Born from',
    h2b: ' AI and Cloud Fusion',
    body: 'N3N.ai specializes in intelligent vision systems and AI cloud infrastructure. Through INNOWATCH and WIZEYE, enterprises can monitor and analyze video, IoT, and system data at unprecedented scale — and act instantly.',
  ...
  products: {
    innowatch: {
      headline: 'Unified Video Management',
      headlineSub: 'Without Location or Cost Limits',
      tag: 'INNOWATCH (Visible Data Control)',
      desc: 'Break network limits and monitor thousands of real-time video streams on a single unified map. GIS-based real-time CCTV integration platform — every camera, one screen.',
      liveCount: 'Thousands Simultaneously',
      features: [
        {
          title: 'Live Video on Map',
          desc: 'Display thousands of real-time CCTV streams and associated data simultaneously on a commercial GIS map.',
        },
        {
          title: 'Display Wall Operation',
          desc: 'Dynamic channel and video stream management optimized for large-screen environments at HQ and central control rooms.',
        },
        {
          title: 'Universal Integration',
          desc: 'Flexible unified monitoring environment regardless of data type — from security-centric mesh systems to enterprise infrastructure.',
        },
      ],
    },
    wizeye: {
      ...
      desc: 'The WIZEYE dashboard delivers real-time alerts on AI-detected anomalies, enabling preemptive response before issues escalate. Collect, refine, and analyze massive IoT sensor data to improve efficiency and reduce costs.',
      features: [
        {
          title: 'Real-time Object Detection & Tracking',
          desc: 'AI vision models detect, classify, and track objects in real time with high precision.',
        },
        {
          title: 'Behavioral Pattern Analysis',
          desc: 'Learn complex behavioral patterns and automatically detect anomalies with instant alerts.',
        },
        {
          title: 'Edge & Cloud Hybrid',
          desc: 'Flexible deployment from edge devices to cloud — real-time processing without latency.',
        },
      ],
    },
    demo: 'Request Demo',
  ...
  usecases: {
    ...
    sub: 'Real operational outcomes from INNOWATCH and WIZEYE. From global enterprises to public infrastructure.',
  ...
  tech: {
    ...
    h2a: 'All Operational Data,',
    h2b: ' One Platform',
    sub: 'A vertically integrated AI stack — from model training to edge deployment. Monitor CCTV, IoT, and server logs in a single click.',
    cards: [
    ...
    nodes: [
      ...
      { label: 'AI Engine', sub: 'N3N OI Core' },
  ...
  contact: {
    ...
    h2b: ' Today',
    sub: 'Request a demo or schedule a consultation. Fill out the form below and we\'ll get back to you promptly.',
